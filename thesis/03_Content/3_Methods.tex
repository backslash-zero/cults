...
Overall, the goal is to find ways in which the concept of cult can be understood as a collective knowledge. 
We're looking for associations, definitions, examples, oppositions, limits.

In order to achieve this, different type of epsitemologies are gathered.
...
Similary we want to do the same with named dimensions of cults, with a certainty ammount. 
