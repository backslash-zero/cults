...
%------------------------------
\usepackage[
	french,						% french language, needed for quoted interview transcripts in the appendix
	ngerman,					% new german language
	english,					% english language
]{babel} 					% language package, last language listed is DEFAULT
...
\usepackage{lscape}			% landscape-oriented pages, used for the wide interview metadata table
...
\usepackage{tikz}			% for the methodology pipeline overview diagram
